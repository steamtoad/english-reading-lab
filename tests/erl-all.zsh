...
"$repo/tests/erl-openclaw-agent-setup.zsh"
"$repo/tests/erl-lexi-vault-binding.zsh"
"$repo/tests/erl-lexi-vault-confirmation-reporting.zsh"
"$repo/tests/erl-book-title-key-topic.zsh"
"$repo/tests/erl-book-title-key-topic-integration-fixtures.zsh"
"$repo/tests/erl-lexi-host-root-separation.zsh"
